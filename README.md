App2.Java is the main file. It contains a password prompt that will not allow the other features to run until the password is guessed correctly. (The password is "password123")
